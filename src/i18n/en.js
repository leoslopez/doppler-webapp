...
const messages_en = {
  ...
  big_query: {
    ...
    plus_body_step_one_MD: `Give access to BigQuery. [HELP] (https://cloud.google.com/bigquery/docs/?hl=es-419)`,
    plus_body_step_two_MD: `Generate Doppler reports at Google Data Studio. [HELP](https://datastudio.google.com/overview)`,
  ...
  checkoutProcessForm: {
    ...
    purchase_summary: {
      ...
      promocode_tooltip: 'Promotions can not be combined with other discounts.',
